...
import TutorialTable from './tableDisplay';
...
const NFTDisplay = () => {
    ...
    const activeAcceptableAttributes = ["Background (14)", "Strap (3)", "Eyes (6)", "ABC"]
    ...
    return (
        <Container id="nftdisplay">
            ...
            <TutorialTable activeAcceptableAttributes={activeAcceptableAttributes} userAvailableAttributes={metaData} />
        </Container>
    )
}
